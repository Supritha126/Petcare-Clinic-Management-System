...
{
	$Product_shortName = $row['product_shotName'];
...
.filter-button:hover {
    font-size: 18px;
    border: 1px solid #d95c32 !important;
    border-radius: 5px;
    text-align: center;
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container-home">
                <div class="row">
                    <div class="col-lg-4 col-md-3 col-sm-12 text-center" style="color: #ED6436 !important;font-weight:bold; font-size:30px; margin-top: 1% !important;"><?php echo $Product_Name?>
                       <a data-toggle="collapse" data-target="#menu" href="#menu" ><i class="fas d-block d-md-none small-menu fa-bars"></i></a>
                    </div>
                    <div id="menu" class="col-lg-6 col-md-6 d-none d-md-block nav-item">
                        <ul>
                            <li><a href="#">Home</a></li>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown"><?php echo $Product_Name?></h5>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <h2>Services At Pet Care Clinic</h2>
            ...
            <div  class="col-sm-12 cop-ck">
                ...
                <h2 class="text-center">Contact Form</h2>
                    ...
                    <div  class="row cf-ro">
                     ...
                     <div  class="row cf-ro">
                        <div  class="col-sm-3 text-right"><label>Enter  Message:</label></div>
                        <div class="col-sm-8">
